...
public:
    ...
    void setupUi(QWidget *DBaseDlgUI)
    {
        ...
        saveBinvoxButton = new QPushButton(DBaseDlgUI);
        saveBinvoxButton->setObjectName(QString::fromUtf8("saveBinvoxButton"));
        saveBinvoxButton->setGeometry(QRect(20, 550, 98, 31));
        line = new QFrame(DBaseDlgUI);
        line->setObjectName(QString::fromUtf8("line"));
        line->setGeometry(QRect(10, 530, 441, 20));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);
        runBatchBinvoxButton = new QPushButton(DBaseDlgUI);
        runBatchBinvoxButton->setObjectName(QString::fromUtf8("runBatchBinvoxButton"));
        runBatchBinvoxButton->setGeometry(QRect(190, 550, 231, 31));
    ...
    void retranslateUi(QWidget *DBaseDlgUI)
    {
        ...
        saveBinvoxButton->setText(QApplication::translate("DBaseDlgUI", "Save .binvox", 0, QApplication::UnicodeUTF8));
        runBatchBinvoxButton->setText(QApplication::translate("DBaseDlgUI", "Create .binvox for all grasps", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
